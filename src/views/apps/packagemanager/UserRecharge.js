...
class UserRecharge extends React.Component {
    ...
    columnDefs: [
...

      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div>
              <span>{params.data.planid?.title}</span>
            </div>
          );
        },
      },
...

      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div>
              <span>{params.data.creditedAmt}</span>
            </div>
          );
        },
      },
  ...
  async componentDidMount() {
    ...
    await axiosConfig.get("/user/recharge_list").then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/admin/del_reList/${id}`).then(
      (response) => {
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          <Breadcrumbs
            breadCrumbTitle="User Recharge "
            breadCrumbParent="Package Management"
            breadCrumbActive=" User Recharge  "
          />
